...
export const HERO_VIDEO_SRC = "https://ik.imagekit.io/14zkbp9ghp/hero.mp4";

export const SHOWCASE_BG_VIDEO_SRC =
    "https://ik.imagekit.io/14zkbp9ghp/showcase.mp4";
...
export const HOW_IT_WORKS_STEPS: HowItWorksStep[] = [
    ...
    },
    {
        ...
        body: "Visionza restyles the image while protecting composition, identity cues, and the small details that matter.",
        icon: SparklesIcon,
        featured: true,
    },
];